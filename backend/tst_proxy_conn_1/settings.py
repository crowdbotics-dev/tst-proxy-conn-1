"""
Django settings for tst_proxy_conn_1 project.
...
ROOT_URLCONF = "tst_proxy_conn_1.urls"
...
WSGI_APPLICATION = "tst_proxy_conn_1.wsgi.application"
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tst_proxy_conn_1 API",
    "DESCRIPTION": "API documentation for tst_proxy_conn_1 App",
    "VERSION": "v1",
}
